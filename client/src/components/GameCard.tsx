  ...
  return (
    <>
      <div className={`game-card group ${featured ? 'flex-none w-full md:w-1/2 lg:w-1/3' : ''}`}>
        <div
          className={`h-full flex flex-col border border-gray-700 rounded-lg overflow-hidden transition-all duration-300 hover:border-accent hover:shadow-lg ${getCategoryColor(game.category)}`}
        >
          <div className="p-5 flex-grow cursor-pointer" onClick={handlePlayClick}>
