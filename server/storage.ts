  ...
  private initializeData() {
    ...
    const defaultGames: InsertGame[] = [
      ...
      },
      {
        ...
        thumbnailUrl: "",
        gameUrl: "https://webglmath.github.io/bloons-tower-defense-5/",
      ...
      {
        title: "Flappy Bird",
        description: "The infamously challenging game where you guide a bird through pipes by tapping to flap its wings. Simple to learn but incredibly difficult to master.",
        thumbnailUrl: "",
      ...
      {
        title: "Cut the Rope",
        description: "Physics-based puzzle game where you cut ropes to feed candy to a little green monster named Om Nom. Timing and strategy are key to collecting all stars.",
        thumbnailUrl: "",
        gameUrl: "https://www.crazygames.com/game/cut-the-rope",
        category: "Puzzle",
        isFeatured: false,
        popular: true,
        isNew: false
      ...
      {
        title: "Geometry Dash",
        description: "Rhythm-based platformer where you control a cube that automatically runs, jumping and flying to avoid obstacles synchronized with the music.",
        thumbnailUrl: "",
